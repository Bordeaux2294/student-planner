...
public class MenuUI extends JFrame{
    ...
    private JMenuItem calculateGradeMenuItem;
    ...
    public MenuUI(String currentUsername) {
        ...
        calculateGradeMenuItem = new JMenuItem("Calculate Grade");
        calculateGradeMenuItem.addActionListener(new MenuItemListener());
        calculateGradeMenuItem.setBackground(new Color(255, 215, 0)); // Yellow background  

        LogoutMenuItem = new JMenuItem("Log Out");
        LogoutMenuItem.addActionListener(new MenuItemListener());
        LogoutMenuItem.setBackground(new Color(255, 192, 203)); // Pink background
        ...
        menubar.add(calculateGradeMenuItem);
    ...
    class MenuItemListener implements ActionListener{
        public void actionPerformed(ActionEvent e){ 
            ...
            if (e.getSource()==calculateGradeMenuItem){
				CalculatorUI window = new CalculatorUI();
				Grades theModel = new Grades();
				GradeCalculatorController theController = new GradeCalculatorController(window, theModel);
